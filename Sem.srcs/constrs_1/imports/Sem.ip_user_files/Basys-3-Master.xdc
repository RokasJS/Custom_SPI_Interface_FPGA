...
##Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {JAA[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {JAA[0]}]
##Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {JAA[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {JAA[1]}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets JAA_IBUF[0]]
##Sch name = JA7
