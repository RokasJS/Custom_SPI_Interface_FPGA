...
HD_PWD='C:/Users/djrok/Documents/Custom_SPI_Interface_FPGA/Sem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MainSPI.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MainSPI.tcl
