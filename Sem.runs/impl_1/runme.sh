...
HD_PWD='C:/Users/djrok/Documents/Custom_SPI_Interface_FPGA/Sem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MainSPI.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MainSPI.tcl -notrace
